...
#
# Created: Fri Apr 19 15:12:41 2013
...
class Ui_showHistory(object):
    def setupUi(self, showHistory):
        ...
        self.gridLayout_4.addWidget(self.loggedActionsWidget, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.panShowGeometry, 2, 0, 1, 1)
        ...
        self.deleteCheckBox = QtGui.QCheckBox(self.groupBox_2)
        self.deleteCheckBox.setChecked(True)
        self.deleteCheckBox.setObjectName(_fromUtf8("deleteCheckBox"))
        self.gridLayout_8.addWidget(self.deleteCheckBox, 0, 2, 1, 1)
        self.beforeCheckBox = QtGui.QCheckBox(self.groupBox_2)
        self.beforeCheckBox.setObjectName(_fromUtf8("beforeCheckBox"))
        self.gridLayout_8.addWidget(self.beforeCheckBox, 1, 4, 1, 1)
        self.beforeDateTimeEdit = QtGui.QDateTimeEdit(self.groupBox_2)
        self.beforeDateTimeEdit.setCalendarPopup(True)
        self.beforeDateTimeEdit.setObjectName(_fromUtf8("beforeDateTimeEdit"))
        self.gridLayout_8.addWidget(self.beforeDateTimeEdit, 1, 5, 1, 1)
        self.updateCheckBox = QtGui.QCheckBox(self.groupBox_2)
        self.updateCheckBox.setChecked(True)
        self.updateCheckBox.setObjectName(_fromUtf8("updateCheckBox"))
        self.gridLayout_8.addWidget(self.updateCheckBox, 0, 1, 1, 1)
        self.afterCheckbox = QtGui.QCheckBox(self.groupBox_2)
        self.afterCheckbox.setObjectName(_fromUtf8("afterCheckbox"))
        self.gridLayout_8.addWidget(self.afterCheckbox, 0, 4, 1, 1)
        ...
        self.insertCheckBox = QtGui.QCheckBox(self.groupBox_2)
        self.insertCheckBox.setChecked(True)
        self.insertCheckBox.setObjectName(_fromUtf8("insertCheckBox"))
        self.gridLayout_8.addWidget(self.insertCheckBox, 0, 0, 1, 1)
        self.afterDateTimeEdit = QtGui.QDateTimeEdit(self.groupBox_2)
        self.afterDateTimeEdit.setButtonSymbols(QtGui.QAbstractSpinBox.UpDownArrows)
        self.afterDateTimeEdit.setDate(QtCore.QDate(1970, 1, 1))
        self.afterDateTimeEdit.setCalendarPopup(True)
        self.afterDateTimeEdit.setObjectName(_fromUtf8("afterDateTimeEdit"))
        self.gridLayout_8.addWidget(self.afterDateTimeEdit, 0, 5, 1, 1)
        spacerItem3 = QtGui.QSpacerItem(30, 20, QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, showHistory):
        ...
        self.deleteCheckBox.setText(QtGui.QApplication.translate("showHistory", "Delete", None, QtGui.QApplication.UnicodeUTF8))
        self.beforeCheckBox.setText(QtGui.QApplication.translate("showHistory", "before", None, QtGui.QApplication.UnicodeUTF8))
        self.updateCheckBox.setText(QtGui.QApplication.translate("showHistory", "Updates", None, QtGui.QApplication.UnicodeUTF8))
        self.afterCheckbox.setText(QtGui.QApplication.translate("showHistory", "after", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.insertCheckBox.setText(QtGui.QApplication.translate("showHistory", "Insert", None, QtGui.QApplication.UnicodeUTF8))
